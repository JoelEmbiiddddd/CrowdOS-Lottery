package cn.crowdos.lottery.domain.activity.service.partake.impl;
...
import cn.crowdos.lottery.domain.activity.model.res.StockResult;
import cn.crowdos.lottery.domain.activity.model.vo.*;
import cn.crowdos.lottery.domain.activity.repository.IUserTakeActivityRepository;
import cn.crowdos.lottery.domain.activity.service.partake.BaseActivityPartake;
...
public class ActivityPartakeImpl extends BaseActivityPartake {
    ...
    @Override
    //4. 扣减活动库存，不通过Redis【活动库存扣减编号，作为锁的Key，缩小颗粒度】
    ...
    @Override
    // 4. 扣减活动库存，通过Redis【活动库存扣减编号，作为锁的Key，缩小颗粒度】 end 即在 BaseActivityPartake 此处完成
