package cn.crowdos.lottery.application.process.deploy;
...
/**
 * @File : IActivityDeployProcess
 * @Author : LiXin Huang, NWPU
 * @Desc : 活动部署接口；查询列表、创建活动、修改活动、删除活动(一般实际场景为逻辑删除)，如果活动的部署需要做一些逻辑校验，那么可以在这一层做编排
